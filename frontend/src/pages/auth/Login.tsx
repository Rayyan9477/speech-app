      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Sign in to continue creating amazing voices</p>
          </motion.div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  className="pl-10 pr-10 h-12 bg-background/50 backdrop-blur-sm border-border/50 focus:border-primary"
                  required
                />
                <button
                  type="button"
